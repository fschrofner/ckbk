...
angular.module('starter', ['ionic', 'ngCordova', 'starter.controllers'])
	...
	var db = null;
		...
		if(db){
		    ...
		    $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS recipes (id integer primary key, name text, category text, prep_time integer, cook_time integer, flags text, persons integer, ingredients text, directions text, image_larger text, image_smaller text)");
